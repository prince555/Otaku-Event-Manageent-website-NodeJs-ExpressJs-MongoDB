...
var addNewCateRouter = require('./routes/add-new-university');
var ViewPassCateRouter = require('./routes/passwordCategory');
var addNewPassRouter = require('./routes/workdone');
...
app.use('/add-new-university', addNewCateRouter);
app.use('/passwordCategory', ViewPassCateRouter);
app.use('/workdone', addNewPassRouter);
